		...
		<div class="py-container">
			<div class="shortcut">
				<ul class="fl">
					...
					<li class="f-item">请 <a href="/Index/login">登录</a>　<span><a href="#">免费注册</a></span></li>
				</ul>
				<ul class="fr">
						...
						<div class="cart-body">
							<div class="cart-list">
								<ul class="goods-list yui3-g">
									...
									<li class="yui3-u-1-8">
											@if($v['shop_price']>$v['new_price'])
												降价:<?php echo $price = ($v['shop_price']-$v['new_price'])?>;
												<?php $v['shop_price']=$v['shop_price']-$price;?>
											@endif
										<span class="price">{{$v['shop_price']}}</span>
										<span>
