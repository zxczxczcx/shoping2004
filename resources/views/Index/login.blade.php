						...
						<div id="profile" class="tab-pane  active">
							...
							<form class="sui-form" action="{{url('/loginDo')}}" method="POST">
								...
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" name="account" type="text" placeholder="邮箱/用户名/手机号" class="span2 input-xfat">
								</div>
								...
								<div class="setting">
									<label class="checkbox inline">
										<a href="https://github.com/login/oauth/authorize?client_id=45097703bfe86eac220a&scope=user:email=8874cd2d9145261064333d927a8d0aa48647c8f1">GITHUB登录</a>
									</label>
