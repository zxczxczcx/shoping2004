			...
			<div class="info">
				...
				<form class="sui-form form-horizontal" action="{{url('/registerDo')}}" method="POST"> 
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="password" name='password' placeholder="再次确认密码" class="input-xfat input-xlarge">
							{{session('pwd')}}
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls btn-reg">
							...
							<button class="sui-btn btn-block btn-xlarge btn-danger" type='submit'>完成注册</button>
						</div>
					</div>
				</form>
